...
const CommonHeaderNext: React.FC = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link href="/" className="text-gray-700 hover:text-teal-600 transition-colors font-semibold">
              ホーム
            </Link>
            <Link href="/about" className="text-gray-700 hover:text-teal-600 transition-colors font-semibold">
              合理的配慮とは
            </Link>
            ...
            <Link href="/developer" className="text-gray-700 hover:text-teal-600 transition-colors font-semibold">
              開発者紹介
            </Link>
          </nav>
...
export default CommonHeaderNext;
