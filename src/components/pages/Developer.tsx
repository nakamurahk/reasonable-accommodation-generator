...
const Developer: React.FC = () => {
  useEffect(() => {
    document.title = '開発者紹介｜InclusiBridge（インクルージブリッジ）';
  }, []);
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-teal-500">
            ...
            <p className="text-sm text-gray-600">
              ...
              <a href="/privacy" className="text-teal-600 hover:text-teal-800 underline">プライバシーポリシー</a>
              および
              <a href="/terms" className="text-teal-600 hover:text-teal-800 underline">利用規約</a>
              をご覧ください。）
            </p>
          </div>
        </div>
