...
const ConceptPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>理念と目指すもの - InclusiBridge</title>
        <meta name="description" content="InclusiBridgeの理念と目指す社会について。配慮を「属人的対応」から「構造的知識」に転換し、配慮を言語化できる社会をつくります。" />
        <meta property="og:title" content="理念と目指すもの - InclusiBridge" />
        <meta property="og:description" content="InclusiBridgeの理念と目指す社会について。配慮を「属人的対応」から「構造的知識」に転換し、配慮を言語化できる社会をつくります。" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://inclusibridge.com/concept" />
        ...
        <link rel="canonical" href="https://inclusibridge.com/concept" />
      </Head>
